...
namespace projeto1
{
    public class Compra
    {
        ...
        { // Método para realizar compras. Verifica em qual seguimento de loja deseja comprar algum produto.
            ...
            if (lojas.Count == 0 && passagens.Count == 0) //verifica se não tem nenhuma loja cadastrada
            {
                Loja loja = new Loja();
                Console.WriteLine("Cadastre uma loja ou passagem primeiro!");
            ...
            else
            {
                ...
                do
                {
                    ...
                    int qtdPassagem = passagens.Count();

                    Console.WriteLine($"\nQuantidade de lojas do segmento FastFood = {qtdLojasFastFood}");
                    ...
                    Console.WriteLine($"Quantidade de passagens cadastradas = {qtdPassagem}");
                    ...
                    {
                        Console.WriteLine("Segmento não possui nenhuma loja");
                    }
                } while (!controle);
            }
        }
